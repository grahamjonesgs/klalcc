...
int main() {
    ...
    if (ok) print_str("PASS"); else print_str("FAIL");
    print_str("  hs="); print_hex_prefix(hs);
    print_str(" ht="); print_hex_prefix(ht);
    print_str(" adv=");  print_int(ht - hs);
    print_str(" used=");      print_int(heap_words_used());
    print_str(" blk0="); print_int(((int*)mem[0])[0]);
    newline();
     ...
     * ========================================================== */
    print_str("chk:T3"); newline();
    p2 = (int *)calloc(4, 4);
    print_str("chk:T3c"); newline();
    ok  = (p2[0] == 0 && p2[1] == 0 && p2[2] == 0 && p2[3] == 0);
    print_str("T3 calloc zero: ");
    if (ok) print_str("PASS"); else print_str("FAIL");
    newline();

    print_str("chk:T4"); newline();
    /* ==========================================================
